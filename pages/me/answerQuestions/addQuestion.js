...
Page({
  ...
  mycourseTap: function () {
    ...
    this.setData({
      smallclassItem: {
        id: smallclassItem.id,
        title: smallclassItem.title,
        shorttitle: smallclassItem.shorttitle
      }
    });
    //选择考试跳转
    const url = '../../course/changeSubject/changeSubject?smallclassItem=' + JSON.stringify(this.data.smallclassItem) + '&flag=addquestion';
    swan.navigateTo({
      url: url
    });
  },
