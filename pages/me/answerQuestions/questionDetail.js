    ...
    api.getConversation({
      ...
      success: (res) => {
        ...
        if (data.errcode == 0) {
          ...
          let starSelectIndex = new Array;
          let starSelectNoIndex = new Array
          for(let i = 0; i < parseInt(starrank); i++){
            starSelectIndex.push({})
          }
          for(let i = 0; i < parseInt(5 - starrank); i++){
            starSelectNoIndex.push({})
          }
          this.setData({ starSelectIndex: starSelectIndex });
          this.setData({ starSelectNoIndex: starSelectNoIndex });
