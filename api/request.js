...
function request_thirdauth(code) {
  ...
  var headimage = "";
  if (userinfo != "") {
    nickname = base64.CusBASE64.encoder(userinfo.nickName);
      ...
      api.thirdauth({
        ...
        success: res => {
          ...
          if (data.errcode == 0) {
            ...
            if (code == "40003" || isUpdateUserInfo == undefined || isUpdateUserInfo != 1) {
